...
meta_tags:
  ...
  - label: "kenya"
    url: "#"
meta_first_written: "2025-03-14"
meta_first_written_label: "~1y"
meta_backlinks: "12"

lede: "This page is about *me* — professionally and personally. For the site's philosophy, design stack, and changelog, see the [About This Site](/site) page."

# ── §01 PROFESSIONAL ──────────────────────────────────────────────────────
professional_epigraph_quote: "The reader lives faster than life, the writer lives slower."
...
websites_epigraph_cite: "Frank Herbert"
websites_epigraph_work: "Dune Messiah"

websites_intro: "Accounts that are actually mine — anything else claiming to be me is not:"
websites_links:
  - label: "GitHub"
    url: "https://github.com/Mwangangi1978"
    note: "code, tools, this site's source"
  - label: "LinkedIn"
    url: "https://www.linkedin.com/in/denis-mwangangi/"
    note: "professional record"
  - label: "Twitter / X"
    url: "https://x.com/byDenisM"
    note: "*@byDenisM* — unfiltered thinking"
  - label: "Substack"
    url: "https://denismwangangi.substack.com/subscribe"
    note: "monthly newsletter, irregular cadence"
  - label: "Watercolor sketches"
    url: "/watercolor"
    note: "a small, ongoing visual practice"
  - label: "Highlights"
    url: "/highlights"
...
software_stack:
  - dt: "Editor"
    dd: "Neovim · minimal config · [dotfiles on GitHub](https://github.com/Mwangangi1978)"
  - dt: "Site"
    dd: "Hugo + Charter & Cooper Hewitt · hosted on Vercel"
  - dt: "Writing"
    dd: "Markdown in plain files · iA Writer on mobile"
  - dt: "Design"
    dd: "Figma (shared work) · pencil + notebook (private)"
  - dt: "Notes"
    dd: "Obsidian vault · synced via git · nothing proprietary"
  - dt: "Reading"
    dd: "reMarkable 2 for papers · paper books for everything else"
  - dt: "Mail"
    dd: "Fastmail · batched replies once a day"
  - dt: "GTM / Data"
    dd: "dbt · BigQuery · Segment · custom dashboards"

hardware_para: >
  A MacBook Pro for travel, a home Linux desktop for anything RAM-hungry,
  a second monitor in portrait orientation for long-form reading,
  a mechanical keyboard, a trackball, and a pair of battered Sony WH-1000XM4s
  that have lived through two continents and one very long flight to Kathmandu.

# ── §02 PERSONAL ──────────────────────────────────────────────────────────
personal_epigraph_quote: >
  Behind a remarkable scholar one often finds a mediocre man,
  and behind a mediocre artist, often, a remarkable man.
...
values:
  ...
  - key: "Allergies"
    value: "Vagueness disguised as vision. Urgency disguised as importance. LinkedIn voice."
  - key: "Currently into"
    value: "Internal tooling. Watercolor gouache. Long walks. Nairobi's quieter neighbourhoods."

funfact_badge: "1"
funfact_badge_label: "Smoot"
funfact_text: >
  *Fun fact.* I am exactly one [Smoot](https://en.wikipedia.org/wiki/Smoot) tall —
...
# ── §03 CONTACT ───────────────────────────────────────────────────────────
contact_intro: >
  The shortest path is email. I answer in batches — please do not take silence personally.
  If you have something long, attach a PDF; I will find time on Monday.

contact_cards:
  - type: "Email"
    url: "mailto:dennomwangs1978@gmail.com"
    display: "dennomwangs1978@gmail.com"
  - type: "LinkedIn"
    url: "https://www.linkedin.com/in/denis-mwangangi/"
    display: "/in/denis-mwangangi"
  - type: "GitHub"
    url: "https://github.com/Mwangangi1978"
    display: "@Mwangangi1978"
  - type: "Twitter / X"
    url: "https://x.com/byDenisM"
    display: "@byDenisM"
  - type: "Substack"
